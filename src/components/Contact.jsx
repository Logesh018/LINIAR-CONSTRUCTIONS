          ...
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            <div className="animate-fade-in-up animation-delay-200">
              <div className="bg-white rounded-3xl p-8 shadow-xl h-full">
                ...
                {submitStatus && (
                  <div className={`mb-6 p-4 rounded-lg ${submitStatus === 'success'
                    ...
                    <div className="flex items-start">
                      ...
                      <div>
                        <p className={`font-semibold ${submitStatus === 'success' ? 'text-green-800' : 'text-red-800'
                          }`}>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={handleChange}
                      className={`w-full px-4 py-3 rounded-lg border-2 ${errors.mobile ? 'border-red-500' : 'border-gray-200'
                        } focus:border-teal-500 focus:outline-none transition-colors`}
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      onChange={handleChange}
                      rows="5"
                      className={`w-full px-4 py-3 rounded-lg border-2 ${errors.description ? 'border-red-500' : 'border-gray-200'
                  ...
                  <button
                    ...
                    className={`w-full gradient-blue text-white py-4 rounded-lg font-bold text-lg shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-105 ${isSubmitting ? 'opacity-50 cursor-not-allowed' : ''
                      }`}
                  >
                    {isSubmitting ? (
