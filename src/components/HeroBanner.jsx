              ...
              <div className="max-w-3xl">
                <div className={`transition-all duration-1000 delay-200 ${
                  ...
                  <div className="flex flex-wrap gap-4">
                    <button className="bg-white text-primary-700 px-8 py-4 rounded-lg font-bold text-lg shadow-2xl hover:shadow-3xl transition-all duration-300 hover:scale-105">
                      Chat on Whatsapp
                    </button>
