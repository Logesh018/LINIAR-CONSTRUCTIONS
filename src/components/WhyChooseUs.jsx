      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
          {reasons.map((reason, index) => (
            ...
            >
              ...
              <p className="text-primary-700 font-semibold mb-3 leading-relaxed">
                {reason.description}
              </p>
              ...
              {/* Decorative element */}
              <div className="mt-6 h-1 w-16 bg-gradient-to-r from-primary-500 to-transparent rounded-full group-hover:w-full transition-all duration-500"></div>
            </div>
          ))}
        </div>
        ...
        <div className="mt-16 text-center gradient-blue rounded-3xl p-12 shadow-2xl max-w-4xl mx-auto">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <button className="bg-white text-primary-700 px-8 py-4 rounded-lg font-bold text-lg shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-105">
              Get Free Consultation
            </button>
            <button className="border-2 border-white text-white px-8 py-4 rounded-lg font-bold text-lg backdrop-blur-sm hover:bg-white hover:text-primary-700 transition-all duration-300 hover:scale-105">
              Call: 8754767261
            </button>
          </div>
        </div>
